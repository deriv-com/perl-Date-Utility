...
ok( !Date::Utility::is_epoch_timestamp('18-Jul-04'),
    '18-Jul-04 not is_epoch_timestamp' );
ok( !Date::Utility::is_epoch_timestamp('2010-01-03 12:34:56'),
    '2010-01-03 12:34:56 not is_epoch_timestamp' );
...
ok( Date::Utility::is_epoch_timestamp(1278382486),
    '1278382486 is_epoch_timestamp' );

# New style  is_ddmmmyy
is( Date::Utility::is_ddmmmyy('2010-01-03 12:34:56'),
    undef, '2010-01-03 12:34:56 not is_ddmmmyy' );
is( Date::Utility::is_ddmmmyy(undef), undef, 'undef not is_ddmmmyy' );
is( Date::Utility::is_ddmmmyy('18-Jul-2004'),
    undef, '18-Jul-2004 not is_ddmmmyy' );
...
is( Date::Utility::month_abbrev_to_number('July'),
    undef, 'July is not a month abbrev' );
